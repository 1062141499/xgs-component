...
redis.log(redis.LOG_WARNING,"============================= redis_record_update start ==================================")
...
--     result=0
-- else
--     redis.call('SET', key_record_key, value_record_key,'EX', value_record_expireTimeSecs,'XX')
--     redis.call('SET', key_record_parameterValues, value_record_parameterValues,'EX', value_record_expireTimeSecs,'XX')
--     redis.call('SET', key_record_parameterTypes, value_record_parameterTypes,'EX', value_record_expireTimeSecs,'XX')
--     redis.call('SET', key_record_result, value_record_result,'EX', value_record_expireTimeSecs,'XX')
--     redis.call('SET', key_record_throwable, value_record_throwable,'EX', value_record_expireTimeSecs,'XX')
--     redis.call('SET', key_record_successCount, value_record_successCount,'EX', value_record_expireTimeSecs,'XX')
--     redis.call('SET', key_record_failCount, value_record_failCount,'EX', value_record_expireTimeSecs,'XX')
--     redis.call('SET', key_record_createTime, value_record_createTime,'EX', value_record_expireTimeSecs,'XX')
--     redis.call('SET', key_record_updateTime, value_record_updateTime,'EX', value_record_expireTimeSecs,'XX')
--     result=1
-- end
...
redis.call('SET', key_record_updateTime, value_record_updateTime,'EX', value_record_expireTimeSecs,'XX')
result=1
redis.log(redis.LOG_WARNING,"============================= redis_record_update end ==================================")

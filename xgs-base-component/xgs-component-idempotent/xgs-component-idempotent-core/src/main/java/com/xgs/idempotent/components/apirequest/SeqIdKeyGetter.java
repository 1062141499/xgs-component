 ...
 */
public class SeqIdKeyGetter implements IdempotentKeyGetter, ApiRequestSupport{
    @Override
    public String parseRecordKey(IdempotentRequestContext requestContext) {
        ...
        PropertyDescriptor propertyDescriptor = BeanUtils.getPropertyDescriptor(data.getClass(), "seqId");
        try {
